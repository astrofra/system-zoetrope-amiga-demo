...
UBYTE font_blit_state = 0, font_width_state = 0;
...
__inline short font_get_string_width(const char *glyph_array, const short *x_pos_array, UBYTE *text_string)
{
	// UWORD i = 0, j, glyph_index, cur_x,
	// 	line_feed = 0, y = 0,
	// 	glyph_w, glyph_h;

	switch(font_width_state)
	{
		case 0:
			i = 0;
			line_feed = 0;
